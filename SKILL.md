        ---
        name: "r00-ComposioHQ-awesome-claude-skills--ecommerce"
        description: >
          🛒 E-commerce & Retail skill suite derived from ComposioHQ/awesome-claude-skills.
...
- `/marketplace-audit` — Amazon/eBay listing health score, Buy Box eligibility and keyword gap
        ...
        ```bash
        # Install this skill
        cp -r . ~/.claude/skills/r00-ComposioHQ-awesome-claude-skills--ecommerce/

        # In Claude Code
        /read ~/.claude/skills/r00-ComposioHQ-awesome-claude-skills--ecommerce/SKILL.md
        ```
